...
import { getHours, HoursProps, MINUTES_IN_DAY_WITH_BORDER } from "@/helpers/DateTime";
import CalendarDayListStyle from "@/styles/components/calendar/day/CalendarDayList";
import GlobalContainerStyle from "@/styles/GlobalContainer";
import GlobalTypographyStyle from "@/styles/GlobalTypography";
import { ConvexEventsAPIProps } from "@/types/api/ConvexEvents";
...
const CalendarDayList = ({
   ...
   * @constant */
  const data = React.useMemo<HoursProps[]>(() => getHours(), []);
