...
import { DatesInWeekInfoProps } from "@/helpers/DateTime";
...
const CalendarWeekDay = ({
  ...
  return (
    <TouchableHaptic 
      ...
      hitSlop={10}
      style={[CalendarWeekDayStyle.view, { gap: 4 }]}>
        <TextBase text={date.shortText} style={[GlobalTypographyStyle.headerSubtitle, { 
          color: highlight, 
        ...
        <ChartDonutProgress
          ...
          <TextBase 
            ...
            style={[GlobalTypographyStyle.headerSubtitle, { fontSize: 12, color: highlight }]} />
        </ChartDonutProgress>
    </TouchableHaptic>
  )
}
...
const CalendarWeekDayStyle = StyleSheet.create({
  view: {
    width: ((Dimensions.get("window").width - (STYLES.paddingHorizontal * 2) - STYLES.paddingHorizontal) / 7),
    alignItems: "center",
