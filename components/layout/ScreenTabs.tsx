...
const ScreenTabs = ({ 
  ...
  const { primaryBgColor, primaryBorderColor, focusedBg, focusedContent, secondaryBgColor, text } = useThemeColors();
          ...
          <TouchableHaptic
            ...
            style={[GlobalContainerStyle.rowCenterCenter, ScreenTabsStyle.haptic, {  
              ...
              <FontAwesomeIcon
                ...
                color={isFocused ? focusedContent : text}
              />
              {isFocused && <TextBase 
                text={String(routes?.title)} 
                style={{ color: isFocused ? focusedContent : text }} />}
            </View>
          </TouchableHaptic>
        );
      })}
